# cloud-itonami-lei-529900s21eq1bo4esm68

> **Independent third-party archive/analysis. Not affiliated with, endorsed by, or sponsored by TotalEnergies SE.**

This repository archives the publicly published Terms of Use / Terms and Conditions of
**TotalEnergies SE**, with source-url and retrieval-date provenance, per
...
- **LEI (ISO 17442)**: [529900S21EQ1BO4ESM68](https://search.gleif.org/#/record/529900S21EQ1BO4ESM68) (GLEIF-verified)
- **Jurisdiction**: FR
- **Website**: https://totalenergies.com
- **Ticker**: TTE (NYSE/Euronext Paris)
