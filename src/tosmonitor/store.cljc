(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (TotalEnergies SE, LEI
  529900S21EQ1BO4ESM68) -- unlike `commitledger.store`'s multi-application
...
(def ^:private demo-full-text
  "Legal Notice\nThis Legal Notice governs your access to and use of the TotalEnergies SE website. By using this site you agree to these terms, which may change without notice. This agreement is governed by French law.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://totalenergies.com/legal"
