...
TotalEnergies SE, per ADR-2607110300 -- a read-only reference archive. As
part of a second 10-repo validation batch extending the
...
- **Company**: TotalEnergies SE, LEI 529900S21EQ1BO4ESM68, website
  `https://totalenergies.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url `https://totalenergies.com/legal`,
